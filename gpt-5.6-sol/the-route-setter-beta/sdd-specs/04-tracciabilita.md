...
| REQ-FIS-008..010 | 02 §7.5, §7.6, §8 | Unit interaction math + E2E gizmo |
| REQ-FIS-011..014 | 02 §6, §7.2, §7.3, §7.7 | Physics headless + targeting tests |
| REQ-FIS-015 | 02 §7.5 | Physics surface-lock + E2E blocco cambio inclinazione |
...
| REQ-UX-001..002 | 02 § Stato fisico e modalita, §8.1..8.2 | E2E popup e macchina a stati |
| REQ-UX-003..005 | 02 §7.1..7.3 | Unit targeting/clustering + E2E aggancio |
| REQ-UX-006..009 | 02 §7.5..7.6, §8.3..8.5 | Unit pointer math + E2E mouse desktop |
...
| REQ-TST-010 | 02 §7..8, 03 FASE 9UX/10 | Unit UX + E2E contestuale completo |
