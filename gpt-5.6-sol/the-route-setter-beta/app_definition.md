...
Muovendo il mouse sulla parete deve comparire un disco target DOM/SVG, pieno e trasparente, di colore giallo, che lascia visibile la parete sottostante. Il disco rappresenta una superficie circolare tangente alla parete nel punto colpito: la sua proiezione prospettica sullo schermo deve quindi apparire come un'ellisse orientata coerentemente con l'inclinazione locale della parete rispetto alla camera. La sua dimensione deriva dalla proiezione della base della presa, con limiti visivi minimi e massimi definiti nel design. Il target non deve far parte della scena Three.js e non deve comparire nell'immagine esportata.
